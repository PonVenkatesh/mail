...
def fetch_data_from_postgres():
    try:
        ...
        # SQL query
        query = """
            SELECT e.email_id, e.sender_id, e.subject, e.body, e.received_at, u.user_id, a.filename, ARRAY_AGG(l.label_id) AS label_ids
            FROM email e
            ...
            GROUP BY e.email_id, u.user_id, a.filename;
        """
